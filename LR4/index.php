                        ...
                        <li>
                            <?php
                                ...
                                else
                                {
                                    ...
                                    echo "<p><a href=\"register.php\">Зарегистрироваться</a> или <a href=\"login.php\">Войти</a></p>";
                                } 
                            ?>
                        </li>
                    </ul>
                        ...
                        <ul class="nav">
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="#">Блог</a></li>
                                    <li><a class="dropdown-item" href="../LR2/index.php">Супер секретная ссылка</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <form class="m-5" method="post"> 
            <textarea class="form-control" name="text"><?php 
                    if (isset($_GET['preset']) && $_GET['preset'] == 1) 
                        echo"$preset1";
                    else if (isset($_GET['preset']) && $_GET['preset'] == 2)
                        echo $preset2;
                    else if (isset($_GET['preset']) && $_GET['preset'] == 3) 
                        echo"$preset3";
                    else echo "";
                ?></textarea>
            <button name="btn" class="btn btn-primary mt-2">Отправить</button>
        </form>
        <?php 
            if (!empty($_POST['text'])) 
            {   
                ...
                */
                ...
                /*
                    7. Удалить повторяющиеся знаки препинания (восклицательные и вопросительные обрезаются до трех, море точек — до многоточия). 
                */
                ex_7($medved);

                echo '<h1>Задание 16</h1>';
                /*
                    16. Фильтр запретных слов. “Запретными словами” в рамках ЛР признаются (в любом регистре) слова “пух”, “рот”, “делать”, “ехать”, “около”, “для”.
                    Задача – заменить на ### (нужное количество символов) запрещенные слова в тексте. Нужно чтобы производные от слов учитывались корректно.
                    Например для запретного слова “рот”
                    “ротовой” => “###овой”, но “коловорот” =>  “коловорот”.
                    Список “запретных слов” должен настраиваться в коде как заданный массив.
                */
                echo $ban_text;
                echo '<br>';
                echo ex_16($ban_text, $ban_word);

                echo '<h1>Задание 11</h1>';
                /*
                    11. Автоматически сформировать работающее оглавление по заголовкам 1-3 уровня. 
                    Под формой должен быть выведено оглавление с отступами по уровням заголовков. Нажатие на заголовок в оглавлении перекидывает на соответствующий заголовок в полный текст.
                    Указания:
                    Для построения оглавления автоматически корректно обрезать заголовки длиннее 50 символов, добавив многоточие
                    Корректно убрать вложенные в 
                    <H> … </H> 
                    теги, если они там есть
                    Сформировать оглавление до третьего уровня с помощью вложенных списков <UL><LI>пункт</LI><UL>
                    Каждый пункт оглавления сделать якорной ссылкой на соответствующий заголовок
                    Вывести работающее красивое оглавление, под ним полный текст статьи и под ней форму для повторной отправки статьи. Полный текст выводится под оглавлением, в него добавляются якоря для простановки ссылок
                */
                ex_11($string);              
            }
        ?>
