...
<body>
    <div class="container">
        ...
        <p>Building</p>
        <input type="text" name="building" value="<?php if(isset($_GET['building'])) {echo $_GET['building'];}  ?>">
        <br>
        <br>
        ...
        <input type="button" value="Бесплатные курсы по OpenCart" onClick='location.href="http://localhost/LR2/"'>
    </form>
